from models.resnet18_cifar100 import resnet18_100
import torch
...
def cifar100_data_loaders(path, shuffle=False, batch_size=256):
...
def train(model, data_path, save_path, epochs):
...
if __name__ == "__main__":
    data_path = "datasets"
    save_path = "classify_cifar100/supervised"
    model = resnet18_100().to(device)
    train(model, data_path, save_path, epochs=100)
